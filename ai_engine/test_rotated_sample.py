...
def main():
    ...
    while cap.isOpened():
        ...
        # Rotate frame 90 degrees clockwise to make person upright
    ...
    print(f"Total frames processed: {len(frames_keypoints)}")
    for detail in frame_details[:10]:
        print("  ", detail)
    ...
    if os.path.exists(tflite_path):
        ...
        print("\n--- Model Prediction Results on Upright sample.mp4 ---")
