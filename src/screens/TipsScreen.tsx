...
const TipsScreen: React.FC<TipsScreenProps> = ({ route }) => {
  ...
  const renderSlide = ({ item: page }: { item: any }) => (
    <View style={[styles.slide, { width: SCREEN_WIDTH }]}>
      {page.special && page.logo ? (
        // Welcome page layout - FIXED for orientation
        <View style={[
          ...
          <View style={[
            ...
            isLandscape && styles.textContainerOneLandscape,
            ...
            <Text style={[
              styles.bodyTextNormal, 
              isLandscape && styles.bodyTextNormalOneLandscape,
              isTablet && styles.bodyTextNormalTablet,
              { fontSize: 19 * (fontSizePercentage / 100), color: isDarkMode ? '#fff' : '#222' }
            ]}>{page.body}</Text>
          </View>
            ...
            <Text style={[styles.modalBody, { fontSize: 16 * (fontSizePercentage / 100), color: isDarkMode ? '#fff' : '#222' }]}>
              {language === 'tagalog' ? (
                <>
                  ...
                  <Text style={styles.yesText}>"Oo"</Text> para sa mabilis na gabay, o{' '}
                  <Text style={styles.noText}>"Hindi"</Text> upang magsimula kaagad.
                </>
              ) : (
                <>
...
const styles = StyleSheet.create({
  ...
  textContainerOneLandscape:{alignItems: 'center', justifyContent: 'center', maxWidth: 400, flex: 1, paddingLeft:0, flexShrink: 1},
  logo: {width:200,height:200,marginBottom:20,borderRadius:20},
  logoLandscape: {width: 180, height: 180, marginBottom: 0, borderRadius: 15, flex: 1, maxWidth: 250,},
  logoTablet: {width:320,height:320,borderRadius:25},
  headerBlock: {alignItems: 'center', marginBottom: 8},
  headerTop: {fontSize: 20, color: '#000', fontWeight: '600', textAlign: 'center'},
  headerTopLandscape: {fontSize: 16, textAlign: 'left', flexWrap: 'wrap', flexShrink: 1},
  headerMain: {fontSize: 34, fontWeight: '800', textAlign: 'center', lineHeight: 40, marginTop: 4},
  headerMainLandscape: {fontSize: 24, lineHeight: 40, marginTop: 2, textAlign: 'left', flexWrap: 'wrap', flexShrink: 1},
  headerMainTablet: {fontSize: 42, lineHeight: 48},
  bodyTextNormalOneLandscape: {fontSize:16,lineHeight:22,textAlign:'center',},
  motion: {color: '#0086b3',  },
  speak: {color: '#808080',  },
  ...
  modalContainer: {backgroundColor:'#fff',borderRadius:20,padding:36,width:'90%',maxWidth:400,minHeight:280,alignItems:'center',shadowColor:'#000',shadowOffset:{width:0,height:2},shadowOpacity:0.25,shadowRadius:4,elevation:5},
  modalContainerTablet: {width:'70%',maxWidth:600,padding:40},
  modalButtons: {flexDirection:'row',justifyContent:'center',gap:13, width:'45%'},
  modalButtonWrapper: {width:'100%',borderRadius:40,overflow:'hidden'},
  modalHeader: {fontSize:24,fontWeight:'700',color:'#000',marginBottom:20,textAlign:'center'},
  modalBody: {fontSize:16,color:'#070303ff',textAlign:'center',lineHeight:22,marginBottom:35},
  modalButtonText: {color:'#fff',fontSize:16,fontWeight:'700'},
  modalButtonTextTablet: {fontSize:18},
  yesText: {color:'#118472',fontWeight:'600'},
  noText: {color:'#430A6D',fontWeight:'600'},

  // LANGUAGE MODAL HEADER STYLES
